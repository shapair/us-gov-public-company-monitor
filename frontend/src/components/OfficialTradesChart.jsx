...
export default function OfficialTradesChart({ chambers = [], transactionTypes = [], limit = 20 }) {
  ...
  useEffect(() => {
    async function load() {
      ...
      try {
        ...
        transactionTypes.forEach((t) => params.append('transaction_type', t))
        const res = await fetch(`${API_BASE}/trades/stats/by-ticker?${params}`)
    ...
    load()
  }, [chambers, transactionTypes, limit])
  ...
  return (
    <div className="apple-card p-6">
      <h3 className="apple-section-title mb-1">Top Tickers by Official Trade Value</h3>

...
export default function FederalStakesChart({ agencies = [], limit = 20 }) {
  ...
  useEffect(() => {
    async function load() {
      ...
      try {
        ...
        agencies.forEach((a) => params.append('agency', a))
        const res = await fetch(`${API_BASE}/stakes/stats/by-ticker?${params}`)
  ...
  if (data.length === 0) return <div className="apple-card p-10 text-apple-ink-muted-48 text-apple-body">No stake data available.</div>

  return (
    <div className="apple-card p-6">
      <h3 className="apple-section-title mb-1">Top Tickers by Federal Stake Amount</h3>
        ...
        <ResponsiveContainer width="100%" height="100%">
          ...
          >
            ...
            <Tooltip
              ...
              formatter={(value) => [formatCompact(value), 'Amount']}
